...
// const makeApptTestData = TestData.makeApptTestData(); // -> Returns 3 objects of test data from test-data.ts
const csvFilePath = path.resolve(`${process.cwd()}/data/functional/make-aptmnt-test-data.csv`) // using csv data
const makeApptTestData = fileHelper.readCSV(csvFilePath)

console.log(makeApptTestData);
